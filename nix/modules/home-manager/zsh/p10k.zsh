# Generated by Powerlevel10k configuration wizard on 2025-08-12 at 13:27 JST.
...
# 2 lines, solid, left frame, black-ornaments, sparse, few icons, fluent,
...
() {
  ...
  ##################################[ host: hostname ]##########################
  typeset -g POWERLEVEL9K_HOST_FOREGROUND=2
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_DIRENV_VISUAL_IDENTIFIER_EXPANSION='󰉋'
  ...
  typeset -g POWERLEVEL9K_NIX_SHELL_VISUAL_IDENTIFIER_EXPANSION=' direnv'
  ...
  # typeset -g POWERLEVEL9K_CHEZMOI_SHELL_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_CHEZMOI_SHELL_VISUAL_IDENTIFIER_EXPANSION='󰋞'
  # typeset -g POWERLEVEL9K_CHEZMOI_SHELL_VISUAL_IDENTIFIER_EXPANSION=''
  ...
  typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND=5
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_TIME_PREFIX='%F{8} %f'
